...
Feature: Different Languages Outlines
  ...
  Scenario Outline: As a user, I want to randomly select a language that returns a 200 response.
    Given there is a GET request containing a randomly chosen text in a different language
